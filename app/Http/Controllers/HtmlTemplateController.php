...
//
            ...
            $application_created_at = $dossier_evaluation_details->created_at->format('d/m/Y');
            ...
            return view($template->path, ['breadcrumb_title' => $breadcrumb_title,
                'reference_letter'=>$reference_letter,'users'=>$users,'dossier_evaluation_details' => $dossier_evaluation_details,
                'date' => $date,'template'=>$template, 'application_created_at' => $application_created_at]);
