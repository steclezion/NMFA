                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title"><strong>New Decision Meeting</strong>
                            </h3>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('store_meeting') }}">
                                ...
                                <div class="form-group">
                                    <div class="modal-footer justify-content-between">
                                        ...
                                        @if(count($completed_assessment_assignments)>0)
                                            <button type="submit" class="btn btn-primary"><i
                                                        class="fas fa-eye"></i> Preview and Send Letter
                                            </button>
                                        @else
                                            <button type="submit" class="btn btn-secondary"
                                                    title="No Completed Evaluations" disabled><i
                                                        class="fas fa-eye"></i> Preview and Send Letter
                                            </button>
                            ...
                            <div class="card card-outline card-success">
                                <div class="card-header">
                                    <h3 class="card-title"><strong>Completed Dossier Evaluations</strong>
                                    </h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                ...
                                <table id="example1"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0"
                                            ...
                                            width="20%" id="subject"> Application Number
                                        </th>
                                        <th class="sorting" tabindex="0"
                                            aria-controls="example1"
                                            rowspan="1" colspan="1"
                                            aria-label="Title: activate to
                                                sort column ascending"
                                            width="20%" id="subject"> Dossier Ref. Num.
                                        </th>
                                        <th class="sorting" tabindex="0"
                                            aria-controls="example1"
                                            rowspan="1" colspan="1"
                                    ...
                                    <tbody>
                                    @php($i=1)
                                    @foreach($completed_assessment_assignments
                                    as $evaluation)
