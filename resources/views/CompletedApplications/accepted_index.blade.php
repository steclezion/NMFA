                                    ...
                                    @foreach($accepted_decisions as $decision)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('applicant_decision_details',[$decision->id])  }}" class="btn btn-info btn-sm"><i class="fas fa-list"></i> </a>
                                                
                                               

                                                                                <a title="Post Registration Follow-up" class='btn btn-sm btn-secondary' href="{{ route('application.process_further',$decision->application_id)  }}">
