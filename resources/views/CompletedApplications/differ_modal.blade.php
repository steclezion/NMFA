                ...
                <form name="upload_response" method="POST"
                    ...
                    <textarea id="summernote" class="form-control" name="data" style="height: 300px; display: none;font-size: xx-large">
                                        ...
                                        <span style="color:#2E74B5;mso-themecolor:accent1;mso-themeshade:191" id="defer_company_name"> </span><br>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;street/plot number: <span style="color:#2E74B5;mso-themecolor:accent1;mso-themeshade:191" id="defer_plot_number">  </span><br>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;region/state: <span style="color:#2E74B5;mso-themecolor:accent1;mso-themeshade:191" id="defer_region"> </span><br>
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;country: <span style="color:#2E74B5;mso-themecolor:accent1;mso-themeshade:191" id="defer_country"></span>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form name="upload_response" method="POST"
                                ...
                                <div class="form-group">
                                    <label for="rejection_letter">  Body</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <textarea type="text" name="body" id="rejection_letter" class="form-control" required></textarea>
