...
<input hidden id="application_nummber" value="{{$checked->application_number}} " />
...
<b> Subject: Decision on </b> [registration] <b>application for</b> {{$checked->product_name}}, {{$checked->dname}} ,{{$checked->product_trade_name}} </b> 
<br/><br/>
...
]) has been completed. The National Medicines and Food Administration, at its discretion,
has decided to <b> reject </b>  the application for the following reason(s):
<br>
1.
<br>
2.
...
<br><br><br>
<p>
Please be advised that you may reapply for registration in the future after fulfilling all the necessary requirements.
</p>
</block>
<br/><br/>
<p> Best regards,  </p>
...
<img src="../../../images/nmfa_footer.png"  alt="image" style="width: 100%;height: auto;"/>       
   ...
   title="save acknowledgment letter"
                id="letter_reject_acknowledgment">
...
@include('layouts.modal_upload_rejection_letter')
