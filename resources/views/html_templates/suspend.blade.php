        ...
        <form method="POST" action="{{ route('save_to_draft') }}">
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title"><B>Suspension Letter</B></h3>
                </div>
                <!-- /.card-header -->
                                    ...
                                    @endif </span>
										...
										<br>
                                         ...
                                         <span style="color:#2E74B5;mso-themecolor:accent1;mso-themeshade:191"> @if (isset($dossier_evaluation_details->dossier_ref_num))
											...
											at its discretion, has decided to <B>Suspend</B> your product for the following reason/s:      
											<br>
											1. 
											<br>
											<br>
											
											As such the registration status of the product will remain suspended until further notice or <span style="color:#2E74B5;mso-themecolor:accent1;mso-themeshade:191">(date/month/year)</span>.
