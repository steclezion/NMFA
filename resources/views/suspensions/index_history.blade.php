                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Post Market History</h3>
                                ...
                                <table id="example1"
                                    ...
                                    @foreach($applications as $application)
                                        <tr role="row">
                                            ...
                                            <td tabindex="0"><B>{{$application->action_taken}}</B></td>
											...
											@if($application->action_taken=='Withdrawn')
                                                <a href="{{ route('withdrawals.show', [$application->suspension_id]) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
											@else
                                                <a href="{{ route('suspensions.show_void', [$application->suspension_id]) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>												
											@endif
                                            </td>
                                        </tr>
                                    @endforeach
