...
@include('layouts.check_list_js_re')
...
<meta name="csrf-token" content="{{ csrf_token() }}">
   ...
   <div class="col-12" id="print_checklist" style="color: #337ab7">
      ...
      <h3 class="card-title">Checklist for Receiving Re-registration Applications
       ...
       <h3 class="pull-left"> Preliminary Screening Checklist for Re-registration</h3>
       <div class="container-fluid">
        <!-- Section one product details  -->
        <div class="card card-outline  card-primary  collapsed-card" >
          <div class="card-header">
          <h3 class="card-title">Section 1: Product Details</h3>
          @foreach($check_list as $application_id ) <input disabled hidden type="text" disabled value= "{{ $application_id->application_id }}"  id="app_id"/>
          @endforeach
                  ...
                  <tbody>
                    ...
                    <tr>
                     ...
                     <!-- {{  $product_name->product_name }} -->
                      ...
                      <input disabled name="strength"  class="form-control" value="{{$product_name->product_name }}" type="" />
                 @break
                      @endforeach
                      </td>
             ...
             <div class="card-tools">
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered  table-condensed table-striped">
                  ...
                  <tbody>
                  <tr>
                     <td>1. Presence of application form </td>
                     <td ></td>
    ...
    @php if( $check_lists->is_application_letter == 1) { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 
                     <td ><input disabled type="checkbox"  {{ $check_yes }}  style="width: 25px"   id="Presence_of_application_letter_yes" name="Presence_of_application_letter" class="form-control"  width="40"/></td>
                     <td ><input disabled type="checkbox"  {{ $check_no }}  style="width: 25px"   id="Presence_of_application_letter_no" name="Presence_of_application_letter" class="form-control"  width="40"/></td>
                     <td> </td>
                   </tr>
                    <tr>
                      <td>2. Presence of manufacturer and manufacturing sites details </td>    
                      <td ></td>
 @php if( $check_lists->is_manufacturer_inforamation == 1) { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 

                      <td ><input disabled type="checkbox"  {{ $check_yes}}  style="width: 25px"   id="manufacturer_information_yes" name="manufacturer_information" class="form-control"  width="40"/></td>
                   
                      <td><input disabled type="checkbox"  {{ $check_no }}  style="width: 25px"      id="manufacturer_information_no" name="manufacturer_information" class="form-control"  width="40"/></td>
                     
                    </tr>


                          <tr>
       <td>3. Presence of Local Authorized Agent (LAA) information </td>
       <td > </td>
@php
...
@endphp 
                      ...
                      <td ><input disabled type="checkbox" {{ $check_yes}}  style="width: 25px"     id="local_agent_yes" name="local_agent" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox" {{ $check_no}}  style="width: 25px"      id="local_agent_no" name="local_agent" class="form-control"  /></td>
                      <td ><input disabled type="checkbox" {{$check_not_app }}  style="width: 25px" id="local_agent_not_applicable" name="local_agent" class="form-control"  /></td>
                      </tr>

                   <tr>
    <td>4. Presence of the product in the Eritrean List of medicines (ENLM)    
    ...
    @php if( $check_lists->is_enlm  == 1) { $check_yes='checked';$check_no='';$check_not_app='';} 
      ...
      @endphp 
                      ...
                      <td ><input disabled type="checkbox" {{ $check_yes}}  style="width: 25px"    id="enlm_yes" name="enlm"  class="form-control"  width="40"/></td>
                 
                    <td ><input disabled type="checkbox"  {{ $check_no }}style="width: 25px"  id="enlm_no" name="enlm"  class="form-control"  width="40"/></td>
                    <td> </td>
...
<td ><input disabled type="checkbox" {{ $check_yes}}  style="width: 25px"   id="dossier_ctd_yes" name="dossier_ctd"  class="form-control"  width="40"/></td>
<td ><input disabled type="checkbox"  {{ $check_no}} style="width: 25px"   id="dossier_ctd_no" name="dossier_ctd"  class="form-control"  width="40"/></td>
<td> </td>
           ...
           <td rowspan='5'>5. Availability of the relevant materials required for re-registration </td>
           <!-- <div class="panel-group"> <div class="panel panel-default"> <div class="panel-heading pace-center-simple-lime"> <h4 class="panel-title"> <a class="btn btn-info btn-sm" data-toggle="collapse" href="#collapse4"><b class="fas fa-angle-double-right"> </b> </a></h4></div><div id="collapse4" class="panel-collapse collapse"><div class="panel-body"><span style="color:skyblue">  [Please tick the boxes if the relevant modules are available or if certain modules are missing please fill the comment section the acceptable reasons of its absence]</span></div></div></div></div> -->
                      ...
                      <td ><input disabled type="checkbox" {{ $check_yes}}  style="width: 25px"   id="module_one_yes" name="module_one" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox" {{ $check_no}}  style="width: 25px"   id="module_one_no" name="module_one" class="form-control"  width="40"/></td>
                      <td> </td>
                      </tr>
                      <tr>
                      <td >Variation Documents </td>
                      @php if( $check_lists->is_module_two == 1) { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 

                      <td ><input disabled type="checkbox" {{ $check_yes}}  style="width: 25px"   id="module_two_yes" name="module_two" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox" {{ $check_no}}  style="width: 25px"   id="module_two_no" name="module_two" class="form-control"  width="40"/></td>
                      <td> </td>
                      </tr>
                      <tr>
                      <td >Batch Manufacturing Record (BMR)</td>
                      @php if( $check_lists->is_module_three == 1) { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 

                      <td ><input disabled type="checkbox" {{ $check_yes}}  style="width: 25px"   id="module_three_yes" name="module_three" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox" {{ $check_no}}  style="width: 25px"   id="module_three_no" name="module_three" class="form-control"  width="40"/></td>
                      <td> </td>
                      </tr>
                      <td >Periodic Safety Update Reports (PSUR)</td>
                      @php if( $check_lists->is_module_four == 1) { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 

                      <td ><input disabled type="checkbox" {{ $check_yes }}  style="width: 25px"   id="module_four_yes"  name="module_four" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox"  {{ $check_no }} style="width: 25px"   id="module_four_no"   name="module_four" class="form-control"  width="40"/></td>
                      <td> </td>
                      </tr>
                      <td >Annual Product Quality Review</td>
                      @php if( $check_lists->is_module_five == 1) { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 

                      <td ><input disabled type="checkbox"  {{ $check_yes}} style="width: 25px"   id="module_five_yes" name="module_five" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox"  {{ $check_no }} style="width: 25px"   id="module_five_no"  name="module_five" class="form-control"  width="40"/></td>
                      <td> </td>
                      </tr>

            <tr>
            <td colspan='5'>6. Remark :
  ...
  <div class="row">
        ...
        <div class="card card-outline  card-primary  collapsed-card">
          ...
          <h3 class="card-title">Section 3: Specific requirements for fast-track registration</h3>
            ...
            <td ><input disabled type="checkbox"   {{ $check_yes}} style="width: 25px"   id="valid_marketing_authorization_yes" name="valid_marketing_authorization" class="form-control"  width="40"/></td>
            <td ><input disabled type="checkbox"   {{ $check_no}} style="width: 25px"   id="valid_marketing_authorization_no" name="valid_marketing_authorization" class="form-control"  width="40"/></td>
            ...
            <td ><input disabled type="checkbox" {{ $check_yes}}   style="width: 25px"   id="qis_prequalified_products_yes" name="qis_prequalified_products" class="form-control"  width="40"/></td>
            <td ><input disabled type="checkbox" {{ $check_no}}   style="width: 25px"   id="qis_prequalified_products_no" name="qis_prequalified_products" class="form-control"  width="40"/></td>
            ...
            <td ><input disabled type="checkbox" {{ $check_yes}}   style="width: 25px"   id="Presence_of_full_assessment_report_yes" name="Presence_of_full_assessment_report" class="form-control"  width="40"/></td>
            <td ><input disabled type="checkbox"  {{ $check_no}}  style="width: 25px"   id="Presence_of_full_assessment_report_no" name="Presence_of_full_assessment_report" class="form-control"  width="40"/></td>
            ...
            <td ><input disabled {{ $check_yes}}  type="checkbox"  style="width: 25px"   id="Presence_of_the_full_inspection_reports_yes" name="Presence_of_the_full_inspection_reports" class="form-control"  width="40"/></td>
            <td ><input disabled {{ $check_no}} type="checkbox"  style="width: 25px"   id="Presence_of_the_full_inspection_reports_no" name="Presence_of_the_full_inspection_reports" class="form-control"  width="40"/></td>
            ...
            <td ><input disabled {{ $check_yes}} type="checkbox"  style="width: 25px"   id="Product_Characteristics_yes" name="Product Characteristics" class="form-control"  width="40"/></td>
            <td ><input disabled {{ $check_no}} type="checkbox"  style="width: 25px"   id="Product_Characteristics_no" name="Product Characteristics" class="form-control"  width="40"/></td>
            ...
            <td ><input disabled type="checkbox" {{ $check_yes}}  style="width: 25px"   id="information_patient_user_yes" name="information_patient_user" class="form-control"  width="40"/></td>
            <td ><input disabled type="checkbox" {{ $check_no}}  style="width: 25px"   id="information_patient_user_no" name="information_patient_user" class="form-control"  width="40"/></td>
            <td ><input disabled type="checkbox" {{$check_not_app }}  style="width: 25px"     id="information_patient_user_not_applicable" name="information_patient_user_not_applicable" class="form-control"  /></td>
  ...
  <div class="row">
        ...
        <div class="card card-outline  card-primary  collapsed-card">
          ...
          <h3 class="card-title">Section 4: Sample details</h3>
                ...
                <table class="table table-bordered  table-condensed table-striped">
                  ...
                  <tbody>
                     ...
                     @php if( $check_lists->Availability_of_Product_Sample == 1) { $check_yes='checked';$check_no='';$check_not_app='';}  else if($check_lists->Availability_of_Product_Sample == 0) {$check_no='checked';$check_yes=''; $check_not_app='';} else {$check_no='';$check_yes=''; $check_not_app='checked';}  @endphp 
                      ...
                      <td ><input disabled type="checkbox" {{ $check_yes }}   style="width: 20px"  id="sample_product_yes" name="sample_product" class="form-control"  width="40"/></td>
                      @else 
                      <td ><input disabled type="checkbox" {{ $check_yes }}  style="width: 20px"   id="sample_product_yes" name="sample_product_information" class="form-control"  width="40"/></td>
                      @endif
                      <td>
                      <input disabled type="checkbox" {{ $check_no }}   size="30" hieght="40"     id="sample_product_no" name="sample_product_no" class="form-control"  width="40"/>
                      </td>
                      <td> 
                      <input disabled type="checkbox" hidden  {{ $check_not_app }}  style="width: 20px"    id="sample_product_not_applicable" name="sample_product_not_applicable" class="form-control"  width="40"/>
                      </td>
                      </tr>
            ...
            <td colspan='4' > <input disabled type="number" min='0'  onkeyup="AllowonlyText_Tele(event,'Number_of_sample_received')"  palceholder = "How many received?? "size="30" hieght="40"   value="{{ $check_lists->Number_of_samples_received}}"    id="Number_of_sample_received" name="number_of_sample_received" class="form-control"  width="40"/></td>
            </tr>
                      ...
                      <td ><input disabled type="checkbox"  {{ $check_yes }} size="30" hieght="40"  id="sample_scheduled_yes" name="sample_sent" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox"  {{ $check_no  }}  size="30" hieght="40"  id="sample_scheduled_no" name="sample_sent" class="form-control"  width="40"/></td>
                      <!-- <td ><input disabled type="checkbox"  style="width: 20px"  id="sample_scheduled_not_applicable" name="sample_sent" class="form-control"  width="40"/></td> -->
                     </tr>
                      ...
                      <input disabled value="{{ $check_lists->Labelling_Information }}" id="section_four_remark"  type="text" disabled  size="30" hieght="40"  id="labelinfo"  
...
<!-- <td ><input disabled type="checkbox"  size="30" hieght="40"  id="sample_volume_yes" name="sample_volume" class="form-control"  width="40"/></td>
<td ><input disabled type="checkbox"  size="30" hieght="40"  id="sample_volume_no" name="sample_volume" class="form-control"  width="40"/></td> -->
<td colspan='4' >

Net Weight or Volume:<input disabled  value="{{ $check_lists->Sample_net_volume_or_weight }}" size="30" hieght="40"  id="sampling_net_weight" placeholder="Enter Weight or Volume"  name="sampling_net_weight" class="form-control"  width="40"/> 
Remark <input disabled value="{{ $check_lists->Sample_net_volume_or_weight_remark }}" id="section_four_remark_netweight"  type="text" disabled  size="30" hieght="40"  id="labelinfo"  name="label_info" class="form-control"  width="40"/>
                      ...
                      <td ><input disabled type="checkbox"  {{ $check_yes}} style="width: 20px"  id="availability_packages_yes" name="availability_packages" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox"  {{ $check_no}} style="width: 20px"  id="availability_packages_no" name="availability_packages" class="form-control"  width="40"/></td>
                      <td>  </td>
                      </tr>
                      ...
                      <td ><input disabled type="checkbox" {{ $check_yes}}  style="width: 20px"  id="manufacturing_premises_yes" name="manufacturing premises" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox" {{ $check_no}}  style="width: 20px"  id="manufacturing_premises_no" name="manufacturing premises" class="form-control"  width="40"/></td>
                      </tr>
  ...
  if( $check_lists->Samples_have_at_least_60_perecent == 1){ $check_yes='checked';$check_no='';$check_not_app='';}  
                      ...
                      <td ><input disabled type="checkbox" {{ $check_yes }} style="width: 20px"  id="sample_shelf_life_yes" name="sample_shelf_life" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox" {{ $check_no }} style="width: 20px"  id="sample_shelf_life_no" name="sample_shelf_life" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox" {{ $check_not_app }} style="width: 20px"  id="sample_shelf_life_not_applicable" name="sample_shelf_life" class="form-control"  width="40"/></td>
                      </tr>
        ...
        { $check_yes='checked';$check_no='';}  else {$check_no='checked';$check_yes=''; } @endphp 
                      ...
                      <td ><input disabled type="checkbox"  {{ $check_yes }}  size="30" hieght="40"  id="availability_certificate_analysis_yes" name="availability_certificate_analysis" class="form-control"  width="40"/></td>
                      <td ><input disabled type="checkbox" {{ $check_no }}    size="30" hieght="40"  id="availability_certificate_analysis_no" name="availability_certificate_analysis" class="form-control"  width="40"/>
   ...
   <tr>
                      ...
                      <td colspan='4'> <input disabled  type="date"  value ="{{ $check_lists->sample_received_date }}" size="30" hieght="40"  id="sample_received_date"   name="label_info" class="form-control"  width="40"/>
                      </td>
                      </tr>
...
@endif
 ...
 <td ><input disabled type="text" disabled  size="30" hieght="40" readonly  id="Generated_Invoice_Number"  value="{{ $invoice_num }}" placeholder="Invoice Number" name="Generated_Invoice_Number" class="form-control"  width="40"/></td>
                 </tr>
                 <tr>
        <td > Registration fee paid. <br></td>
       <!-- <td ><input disabled type="text" disabled  size="30" hieght="40"  id="checking_application_fee_no" name="checking_application_fee" class="form-control"  width="40"/></td> -->
       <td> </td> 
       ...
       <td ><input disabled type="checkbox"  {{ $check_yes }}  id="checking_application_fee_yes" name="checking_application_fee" class="form-control"  width="40"/></td>
       <td ><input disabled type="checkbox"  {{ $check_no }} id="checking_application_fee_no" name="checking_application_fee" class="form-control"  width="40"/></td>
       </tr>
       <tr>
      ...
      <input disabled type="text" disabled  size="30" hieght="40"  readonly placeholder="Receipt  Number"  value="{{ $receipt }}"
...
<br>
             <table class="table table-bordered  table-condensed table-striped">
                  ...
                  <td > Remark <br></td>
 <td ><textarea type="text" disabled  size="30" hieght="40"   placeholder="Remark"  id="Remark_section_five" placeholder="" name="Remark" class="form-control"  width="40"/>{{ $remark_section_five }} </textarea> </td>
                 </tr>
      ...
      <td ><textarea type="text" disabled    placeholder="Comments"  id="over_all_comment" name="Application_Receipt_Number"  class="form-control"  width="40"/>  {{   $comment}}  </textarea>
      </td>
      </tr>
      </tbody>
      </table>
      ...
      <br/><br/>
                ...
                <div class="form-group">
                    ...
                    <input disabled type="text" disabled name="assessor_name"  readonly value=" {{ Auth::user()->first_name." ".Auth::user()->middle_name." ".Auth::user()->last_name }}"class="form-control" id="exampleInputEmail1" placeholder="Enter Assessor Name">
                  </div>


                      <div class="form-group">
                      <label style="font-size:20px;" for="exampleInputEmail1">Date</label>
                      <input disabled type="text" disabled name="date" readonly value="@php $t=time(); echo date("Y-m-d",$t); @endphp"  class="form-control" id="exampleInputEmail1" placeholder="Enter Assessor Name">
                      </div>
               ...
               foreach($check_list as $dossier)
                    ...
                    <input disabled type="path" name="path" width="50" class="form-control" id="path_dossier" readonly value="Dossier/{{$dossier->dossier_actual_path}}/">
                    </div>
              ...
              <button hidden class="btn btn-primary"  id="send_message_to_supervisor" > <i class="fas fa-message">  </i> Send comments</button> 

              <a href="{{ route('checklist.process_check_list_re', $dossier->application_id)}}" rel="noopener" target="_blank" class="btn btn-info"><i class="fas fa-print"></i> Print</a>
    ...
    <!-- <button class="btn btn-warning"  id="check_steps"  > <i class="fas fa-arrow-alt-circle-right"></i> Proceed   </i> </button> -->
