...
(Dossier Status By : <span style="color:green" > {{ $dossier->dossier_url }}   </span>  </a> ) 
                ...
                <td><span class="badge bg-success"><i class="fa fa-check"></i></span></td>
                 ...
                 @break
                      ...
                      {{  $dosage_formss->name   }}<br>
                           ...
                           <tr>
                      <td {{ $i=1 }}>Market Authorization Holder   </td>
                      <td>
    ...
    <!-- Section 2 General requirements for fast-track registration-->
       ...
       <td > </td>
            ...
            <tr>
    <td>4. Presence of the product in the Eritrean List of medicines (ENLM)      <!-- <div class="panel-group"> <div class="panel panel-default"><div class="panel-heading pace-center-simple-lime"><h4 class="panel-title"> <a class="btn btn-info btn-sm" data-toggle="collapse" href="#collapse3"><b class="fas fa-angle-double-right"> </b> </a></h4></div><div id="collapse3" class="panel-collapse collapse"><div class="panel-body"><span style="color:skyblue">  [If the pharmaceutical product is not listed in the ENLM ensure that the reason for its permit registration is filled in the comment section.] </span></div></div></div>
       -->
      </td>
    <td ></td>
@foreach($product_enlm_list as $list)     @endforeach
                    ...
                    <td> </td>
                          ...
                          <!-- <tr>
    <td>5. Presence of the submitted dossier in CTD format as per the requested format  
    ...
    <td ></td> -->
                    ...
                    <td> </td>
                      ...
                      <tr>
                      <td rowspan='5'>5. Availability of the relevant materials required for re-registration
...
.dark-red {
    color: magenta;
           ...
           <br>
           <button title="Supervisor will assess" disabled  class="btn btn-warning"  id="submit_to_supervisor_section_two" >  Re-Submit section two to supervisor</button> 
...
@endif
  ...
  <div class="row">
        ...
        <div class="card card-outline card-primary">
          ...
          <h3 class="card-title">Section 4: Sample details</h3>
            ...
            <td colspan='4' > <input type="number" min='0' onkeyup="AllowonlyText_Tele(event,'Number_of_sample_received')"   palceholder = "How many received??" size="30" hieght="40"     id="Number_of_sample_received" name="number_of_sample_received" class="form-control"  width="40"/></td>
            </tr>
  ...
  <td colspan="4"> Remark 
<input value="" 
id="section_four_remark"  type="text"  size="30" hieght="40" 
id="labelinfo"   name="label_info" class="form-control"  width="40"/>
          ...
          <h3 class="card-title">Section 5: Payment details</h3>
             <div class="card-tools">
              ...
              <table class="table table-bordered  table-condensed table-striped">
                  ...
                  @php if( ($inv_num->invoice_number) == '') 
                   { $invoice_num =''; } else { $invoice_num = $inv_num->invoice_number;} 
            @endphp
                   @endforeach 
                  
                  
 <td >
 <input type="text"  size="30" hieght="40" readonly  id="Generated_Invoice_Number"  value="{{ $invoice_num }}" 
  placeholder="Invoice Number" 
  name="Generated_Invoice_Number" 
  class="form-control"  
  width="40"
