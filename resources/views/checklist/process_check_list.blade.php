 ...
 @section('content') @php $invoice_num=''; @endphp
...
<link rel="stylesheet" href="{{asset('plugins/toastr/toastr.min.css')}}"> @include('layouts.check_list_js')
    ...
    <div class="col-12">
        ...
        <div class="card-header">
            <h3 class="card-title">Checklist for Receiving Registration Applications
                <!--       
      @if (!filter_var($dossier->dossier_url, FILTER_VALIDATE_URL) === false)

       <span style="color:green" >(<a href='{{  $dossier->dossier_url  }}'> Dossier Link  </a> )   </span>
      @else

(Dossier Status By : <span style="color:green" > {{ $dossier->dossier_url }}   </span>  </a> ) 
    ...
    @endif -->
            ...
            <div class="container-fluid" id="print_checklist">
                <!-- Section one product details  -->
                <div class="card card-outline  card-blue">
                    <div class="card-header">
                        <h3 class="card-title">Section 1: Product Details</h3>
                        @foreach($check_list as $application_id )
                        <input hidden type="text" value="{{ $application_id->application_id }}" id="app_id" /> @endforeach
            ...
            <td>Application ID</td>
               ...
               @endforeach
                ...
                <td><span class="badge bg-success"><i class="fa fa-check"></i></span></td>
                                ...
                                <tr>
                                    <td>Generic Name</td>
                                    <td>{{ $font_product_name='' }} @foreach( $check_list as $product_name ) {{ $product_name->product_name }} @break @endforeach
                                    </td>
                     ...
                     @endif </td> -->
                                ...
                                <tr>
                                    <td>Brand Name</td>
                                    <td>
                                        @foreach($check_list as $product_trade_name ) {{ $product_trade_name->product_trade_name }} @break @endforeach
                                    </td>
                                </tr>
                                ...
                                <!-- <tr>
                                    ...
                                    <td>
                                        ...
                                        <input name="strength" class="form-control" value="{{$product_name->product_name }}" type="" /> @break @endforeach
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @foreach ($dosage_forms as $dosage_formss) @endforeach {{ $dosage_formss->name }}<br>
                     ...
                     $font_product_name='<span class="badge bg-danger"><i class="fa fa-minus"></i></span>'
                      @else <span class="badge bg-success"><i class="fa fa-check"></i></span>  @endif </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @php foreach($check_list as $track_mode) { if($track_mode->application_type== 1) { $track_mode->fast_track_details = 'Standard Mode'; } echo $track_mode->fast_track_details; break; } @endphp
                                    </td>
                                ...
                                <table class="table table-bordered  table-condensed table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" style="width: 20px" id="manufacturer_information_yes" name="manufacturer_information" class="form-control" width="40" /></td>

                                            <td><input type="checkbox" style="width: 20px" id="manufacturer_information_no" name="manufacturer_information" class="form-control" width="40" /></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" style="width: 20px" id="local_agent_yes" name="local_agent" class="form-control" width="40" /></td>
                                            <td><input type="checkbox" style="width: 20px" id="local_agent_no" name="local_agent" class="form-control" /></td>
                                            <td><input type="checkbox" style="width: 20px" id="local_agent_not_applicable" name="local_agent" class="form-control" /></td>
                                        </tr>
       ...
       -->
                                            ...
                                            <td><input type="checkbox" style="width: 20px" id="enlm_yes" name="enlm" class="form-control" width="40" /></td>

                                            <td><input type="checkbox" style="width: 20px" id="enlm_no" name="enlm" class="form-control" width="40" /></td>
                                            <td> </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="checkbox" style="width: 20px" id="dossier_ctd_yes" name="dossier_ctd" class="form-control" width="40" /></td>

                                            <td><input type="checkbox" style="width: 20px" id="dossier_ctd_no" name="dossier_ctd" class="form-control" width="40" /></td>
                                            <td> </td>
                                        ...
                                        <tr>
                                            <td rowspan='5'> Availability of the module of the CTD
                                            ...
                                            <td><input type="checkbox" style="width: 20px" id="module_one_yes" name="module_one" class="form-control" width="40" /></td>
                                            <td><input type="checkbox" style="width: 20px" id="module_one_no" name="module_one" class="form-control" width="40" /></td>
                                            <td> </td>
                                        </tr>
                                        <tr>
                                            <td>Module II </td>
                                            <td><input type="checkbox" style="width: 20px" id="module_two_yes" name="module_two" class="form-control" width="40" /></td>
                                            <td><input type="checkbox" style="width: 20px" id="module_two_no" name="module_two" class="form-control" width="40" /></td>
                                            <td> </td>
                                        </tr>
                                        <tr>
                                            <td>Module III</td>
                                            <td><input type="checkbox" style="width: 20px" id="module_three_yes" name="module_three" class="form-control" width="40" /></td>
                                            <td><input type="checkbox" style="width: 20px" id="module_three_no" name="module_three" class="form-control" width="40" /></td>
                                            <td> </td>
                                        </tr>
                                        <td>Module IV</td>
                                        <td><input type="checkbox" style="width: 20px" id="module_four_yes" name="module_four" class="form-control" width="40" /></td>
                                        <td><input type="checkbox" style="width: 20px" id="module_four_no" name="module_four" class="form-control" width="40" /></td>
                                        <td> </td>
                                        </tr>
                                        <td>Module V</td>
                                        <td><input type="checkbox" style="width: 20px" id="module_five_yes" name="module_five" class="form-control" width="40" /></td>
                                        <td><input type="checkbox" style="width: 20px" id="module_five_no" name="module_five" class="form-control" width="40" /></td>
                                        <td> </td>
                                        </tr>
                                ...
                                @php foreach($check_list as $checking_mode) {} @endphp
                                ...
                                <br>
                                <button title="Supervisor will assess" disabled class="btn btn-warning" id="submit_to_supervisor_section_two">  Re-Submit section two to supervisor</button> @endif
                    ...
                    @foreach($check_list as $check_applications_check_list ) @endforeach @if($check_applications_check_list->application_type !=1 )
                ...
                <i class="fas fa-times"></i>
                                        ...
                                        <table class="table table-bordered  table-condensed table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" style="width: 20px" id="valid_marketing_authorization_yes" name="valid_marketing_authorization" class="form-control" width="40" /></td>
                                                    <td><input type="checkbox" style="width: 20px" id="valid_marketing_authorization_no" name="valid_marketing_authorization" class="form-control" width="40" /></td>
                                                    <td> </td>
                                                </tr>
                                                    ...
                                                    <td>Presence of the Quality Information Summary (QIS) as approved/ endorsed by the reference authority or WHO
                                                        <div class="panel-group">
                                                            <div class="panel panel-default">
                                                                ...
                                                                <td><input type="checkbox" style="width: 20px" id="qis_prequalified_products_yes" name="qis_prequalified_products" class="form-control" width="40" /></td>
                                                                <td><input type="checkbox" style="width: 20px" id="qis_prequalified_products_no" name="qis_prequalified_products" class="form-control" width="40" /></td>
                                                                <td> </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" style="width: 20px" id="Presence_of_full_assessment_report_yes" name="Presence_of_full_assessment_report" class="form-control" width="40" /></td>
                                                    <td><input type="checkbox" style="width: 20px" id="Presence_of_full_assessment_report_no" name="Presence_of_full_assessment_report" class="form-control" width="40" /></td>
                                                    <td> </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" style="width: 20px" id="Presence_of_the_full_inspection_reports_yes" name="Presence_of_the_full_inspection_reports" class="form-control" width="40" /></td>
                                                    <td><input type="checkbox" style="width: 20px" id="Presence_of_the_full_inspection_reports_no" name="Presence_of_the_full_inspection_reports" class="form-control" width="40" /></td>
                                                    <td> </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" style="width: 20px" id="Product_Characteristics_yes" name="Product Characteristics" class="form-control" width="40" /></td>
                                                    <td><input type="checkbox" style="width: 20px" id="Product_Characteristics_no" name="Product Characteristics" class="form-control" width="40" /></td>
                                                    <td> </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="checkbox" style="width: 20px" id="information_patient_user_yes" name="information_patient_user" class="form-control" width="40" /></td>
                                                    <td><input type="checkbox" style="width: 20px" id="information_patient_user_no" name="information_patient_user" class="form-control" width="40" /></td>
                                                    <td><input type="checkbox" style="width: 20px" id="information_patient_user_not_applicable" name="information_patient_user_not_applicable" class="form-control" /></td>
                                    ...
                                    @foreach($check_list as $check_applications_check_list ) @endforeach @if($check_applications_check_list->application_type !=2 )
                                                        ...
                                                        <table class="table table-bordered  table-condensed table-striped">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    @foreach($check_list as $sample_Status ) @break @endforeach @if( $sample_Status->sample_status == '' )
                                                                    ...
                                                                    @endif
                                                                    <td>
                                                                        <input type="checkbox" style="width: 20px" id="sample_product_no" name="sample_product_no" class="form-control" width="40" />
                                                                    </td>
                                                                    <td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan='4'> <input type="number" min='0' onkeyup="AllowonlyText_Tele(event,'Number_of_sample_received')" palceholder="How many received??" size="30" hieght="40" id="Number_of_sample_received" name="number_of_sample_received"
                                                                            class="form-control" width="40" /></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="checkbox" style="width: 20px" id="sample_scheduled_yes" name="sample_sent" class="form-control" width="40" /></td>
                                                                    <td><input type="checkbox" style="width: 20px" id="sample_scheduled_no" name="sample_sent" class="form-control" width="40" /></td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4"> Remark
                                                                        <input value="" id="section_four_remark" type="text" size="30" hieght="40" id="labelinfo" name="label_info" class="form-control" width="40" />
...
<td ><input type="checkbox"  size="30" hieght="40"  id="sample_volume_no" name="sample_volume" class="form-control"  width="40"/></td> -->
                                                                    <td colspan='4'>
                                                                        ...
                                                                        Net Weight or Volume:<input type="text" size="30" hieght="40" id="sampling_net_weight" placeholder="Enter Weight or Volume" name="sampling_net_weight" class="form-control" width="40"
                                                                ...
                                                                <td> </td>
                                                                <td><input type="checkbox" style="width: 20px" id="availability_certificate_analysis_yes" name="availability_certificate_analysis" class="form-control" width="40" /></td>
                                                                <td><input type="checkbox" style="width: 20px" id="availability_certificate_analysis_no" name="availability_certificate_analysis" class="form-control" width="40" />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan='4'> <input value="" type="date" size="30" hieght="40" id="sample_received_date" name="label_info" class="form-control" width="40" /> </td>
                                                                </tr>


                                                                <tr>
                                                                    <td colspan='3'> Remark : <textarea id="summernote_Remark_section_four" name="remark" class="form-control" auto/> </textarea>
                                                                    </td>
                                                                    <td> </td>
                                                                    <td> </td>
                                                                </tr>
                                                            ...
                                                            <div class="card-body">
                                                                <table class="table table-bordered  table-condensed table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            @foreach($invoice_number as $inv_num ) @php if( ($inv_num->invoice_number) == '') { $invoice_num =''; } else { $invoice_num = $inv_num->invoice_number;} @endphp @endforeach


                                                                            <td>
                                                                                <input type="text" size="30" hieght="40" readonly id="Generated_Invoice_Number" value="{{ $invoice_num }}" placeholder="Invoice Number" name="Generated_Invoice_Number" class="form-control" width="40" />
                                                                            </td>
                                                                        </tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input type="checkbox" style="width: 20px" id="checking_application_fee_yes" name="checking_application_fee" class="form-control" width="40" /></td>
                                                                            <td><input type="checkbox" style="width: 20px" id="checking_application_fee_no" name="checking_application_fee" class="form-control" width="40" /></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Receipt Number</td>
                                                                            <td>
                                                                                @php $receipt = ''; @endphp @foreach($receipts_number as $receipts) @php if($receipts->receipt_number == '') { $receipt = ''; } else { $receipt = $receipts->receipt_number;} @endphp @endforeach
                                                                ...
                                                                <table class="table table-bordered  table-condensed table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td> Remark <br></td>
                                                                            <td><textarea type="text" size="30" hieght="40" id="Remark_section_five" placeholder="" name="Remark" class="form-control" width="40" /></textarea>
                                                                            </td>
                                                                        </tr>
...
<a href="{{ route('checklist.process_check_list', $dossier->application_id)}}" rel="noopener" target="_blank" class="btn btn-info"><i class="fas fa-print"></i> 
Print
</a>

<button class="btn btn-primary"  disabled id="send_message_to_supervisor" > <i class="fas fa-message">  </i> Send comments</button>


                                                                <!-- <a target="_blank" href="{{ route('Acknowledgement_Letter_preliminary_screening',$application_id->application_id) }}" >
                 
                  <span  class="btn btn-warning"  id="acknowledge_letter" > <i class="fas fa-check"></i>   Acknowledgement Letter  </span> 
                </a> -->
