...
<br>
             <table class="table table-bordered  table-condensed table-striped">
                  ...
                  <td > Remark <br></td>
 <td ><textarea type="text"  size="30" hieght="40"   placeholder="Remark"  id="Remark_section_five" placeholder="" name="Remark" class="form-control"  width="40"/>{{ $remark_section_five }} </textarea> </td>
                 </tr>
      ...
      <td ><textarea type="text"    placeholder="Comments"  id="over_all_comment" name="Application_Receipt_Number"  class="form-control"  width="40"/>  {{   $comment}}  </textarea>
      </td>
      </tr>
      </tbody>
      </table>
