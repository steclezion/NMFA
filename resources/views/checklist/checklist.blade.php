...
<section class="content">
    ...
    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" href="{{ url('check_list') }}" aria-selected="true"> <span class="badge bg-primary"> New  </span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link"  href="{{ url('checklist_renew') }}"  role="tab"  aria-selected="false"> <span class="badge bg-primary">  Re-register </span></a>
        </li> 
        <!-- <li class="nav-item">
 ...
 @endphp
    ...
    <td width="10%">
     ...
     <a   class="btn btn-info btn-sm"   id="sam" rel="tooltip"  title="Attest" style="cusror:pointer" 
      ...
      href=" {{ route('application.checklist',$application->application_id)  }}" >  <i class='fas fa-tasks'></i> </a>
