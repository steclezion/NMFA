...
@foreach($application_check_wizard as $app)  Application Number=={{ $app->application_number  }}    @endforeach
</div>
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform">
                            <!-- progressbar -->
        <ul id="progressbar">
        <li  @php if(in_array('0',$explode)) { echo "class='active'"; }  else  {}    @endphp   id="Application_Type" ><strong >Application Type</strong></li>
        <li @if(in_array('1',$explode))  class="active"  @else    @endif   id="supplier" ><strong  >Company Supplier</strong></li>
        ...
        <li @if(in_array('5',$explode))  class="active"  @else    @endif   id="product_composition" ><strong>Product Composition</strong></li>
        <li  @if(in_array('4',$explode)) class="active"  @else    @endif   id="product_manufacturers" ><strong>Product Manufacturers</strong></li>
        <li @if(in_array('6',$explode))  class="active"  @else    @endif   id="product_manufacturers_api" ><strong> API Product Manufacturers</strong></li>
...
<select disabled  style="display:none"   class="form-control" name="new_application_mode" id="new_application_mode"  required  onchange="start_applications(this.value)">
...
<select disabled    style="display:none" class="form-control" name="app_renew_new_application_mode" id="app_renew_new_application_mode"  required  onchange="start_applications(this.value)">
<option value="0" disable="true" selected="true"> </option>
<option value="1"> Standard Mode </option>
@foreach ($fast_track_applications as $key => $value)
<option value="2_{{ $value->name }}">Fast Track Mode {{ $value->name }}</option>
...
<select disabled  style="display:none" class="form-control" name="track_mode" id="app_select_mode"  required>
...
<!-- <button style="display:block" style="position:absolute;left: 50%; top:70%;cursor:pointer;padding:10px 5px;margin: 10px 5px;" style="display:block" type="button" name="next" class="btn btn-primary app_recep_next" value="Next Step"  id="next_button_application"   />Next Step </button> -->
...
<select disabled  class="form-control select2bs4" style="width: 100%;"  name="trade_names" id="trade_names"  required  onchange="check_trade_name(this.value)">
...
<label> Country</label> 
<select disabled class="form-control select2bs4" style="width: 100%;"  name="country_id" id="css_country"  onchange="fetch_tele(this.value,'cs_response_tele','{{url('/get_tele_code/tele_code')}}')"  required>
...
<div class="input-group mb-3">
<select disabled class="form-control select2bs4" name="country_id" id="cont_country"  required  onchange="fetch_tele(this.value,'cont_response_tele','{{url('/get_tele_code/tele_code')}}')">
...
foreach($agent_contact_info as $agent_contact_info) {} foreach($agent_contact_County_info as $agent_contact_County_info)  {}
 ...
 @endphp
    ...
    <div class="input-group mb-3">
                        ...
                        <select disabled disabled id="ag_trade_name"  style="display:block;width:350px;"  onchange="check_trade_agent_name(this.value)"  class="form-control select2bs4">
                        ...
                        @endforeach
                                 ...
                                 <div class="input-group mb-3">
                                    <label> Country  </label>
                                    <select disabled  disabled class="form-control" name="country_id" id="ag_country"  required  onchange="fetch_tele(this.value,'age_response_tele','{{url('/get_tele_code/tele_code')}}')">
   ...
   <input value="{{ $agent_contact_person_last_name }}"  class="form-control" id="cont_ag_last_name" type="text" name="last_name"    required>
     ...
     <input  value="{{ $agent_contact_person_position }}" class="form-control" id="cont_ag_position" type="text" name="position"  />
                                    <label> Country </label> 
                                    <div class="input-group mb-3">
                                    <select disabled class="form-control select2bs4" name="country_id" id="cont_ag_country_id"  required   onchange="fetch_tele(this.value,'cont_age_response_tele','{{url('/get_tele_code/tele_code')}}')">
...
<label >Generic/Approved/International Non-proprietary Name(s): </label>  
    <select disabled   style="display:block;width:350px;" class="form-control select2bs4" style="width:100;"  id="generic_approved_name"   name="Application_type" required  onchange="get_other_value(this.value,'generic_approved_name_other')">
   ...
   <label>Proprietary/Trade name of the product </label>  
    ...
    <input value="{{  $product_trade_name  }}"  class="form-control" id="product_trade_name"  type="text" name="product_trade_name"   />
        <label>Dosage Forms </label>  
             &nbsp;&nbsp;
            <select disabled style="display:block;width:300px;" class="form-control select2bs4" id="dosage_form_id"  name="dosage_form_id"  required>
            ...
            <select disabled  style="display:block;width:200px;" class="form-control select2bs4" id="route_administration_id" name="route_administration_id"   required>
...
<br><br/>
            ...
            <select disabled  class="form-control" id="shelf_life_unit" type="number" name="shelf_life_unit" required>
 ...
 <!--<input class="form-control" id="shelf_life_unit" type="number" name="shelf_life_unit"  required/>  -->
            ...
            <select disabled  style="display:block" class="form-control" id="proposed_shelf_life_unit"  name="proposed_shelf_life_unit"  required  onchange="proposed_shelf(this.value,)">
          ...
          <!--  <input class="form-control" id="proposed_shelf_life_unit" type="text" name="proposed_shelf_life_unit"  placeholder="in-months" required/>-->
            <br>
            <label>Proposed Shelf Life After Reconstitution Amount (if Applicable)</label>  
            ...
            <select disabled  style="display:block" class="form-control" id="proposed_shelf_life_after_reconstitution_unit"  name="proposed_shelf_life_after_reconstitution_unit"  required  onchange="proposed_shelf(this.value,)">
           ...
           @if($proposed_shelf_life_after_reconstitution_unit != 'Days')
            ...
            <label>Category of Use </label>  
             &nbsp;&nbsp;
            <select disabled  style="display:block" class="form-control" id="category_use"  name="category_use"  required>
...
<fieldset  @php if($Last_Element == 5) { echo "style='display:block'"; }  else  {}    @endphp  id="composition_pro">
        ...
        <div class="form-card">
         ...
         <button hidden id="add_new_composition"  class="btn btn-info"> <i class="fas fa-plus"> Add New  </i> </button>
         </h2>
         <div class="container">
                               <!--  <div class="form-group">
                                  <label>Name INN</label>
                                   <select disabled class="form-control select2" id="name_inn" style="width: 100%;">
    ...
    <div class="col-9"> 
    <select disabled class="form-control" id="composition_type_composition" name="composition_type_composition">
    ...
    <select disabled class="form-control" id="reference_standard_composition"  name="reference_standard_composition">
    ...
    <button type="button" class="save action-buttonn"     id="createNewCompostion_save"        > Save </button></span>
    ...
    <tr>
               ...
               <tr>
                        <td>{{ $i++ }}</th>   
                        <!-- <td>{{ $product_composition->application_id  }}</td> -->
...
<!---------------  ------------------------------------------------------------>
 <fieldset    @php if($Last_Element == 4) { echo "style='display:block'"; }  else  {}    @endphp    id="product_manufacturers_wizard">
...
<div class="form-card">
  ...
  <button hidden id="add_new_manufacturer"  class="btn btn-info"> <i class="fas fa-plus"> Add New   </i> </button>
    ...
    <label>Name</label>  
        ...
        <label>Country</label>  
        <select disabled onchange="fetch_tele(this.value,'manu_response_tele','{{url('/get_tele_code/tele_code')}}')" class="form-control select2bs4" style="width: 100%;" name="manufacturer_country_id" id="manufacturer_country"  required>
...
<div class="col-12 col-sm-6">
    ...
    <input type="button" class="save action-buttonn" value="Save"    id="save_product_manufacturer_save"       ></span>
...
@endphp
        ...
        <button  hidden id="add_new_api_product_manufacturer"  class="btn btn-info"> <i class="fas fa-plus"> Add New   </i> </button>
    ...
    <label>Name</label>  
        ...
        <label>Country</label>  
       <select disabled  onchange="fetch_tele(this.value,'manu_api_response_tele','{{url('/get_tele_code/tele_code')}}')"  class="form-control select2bs4" style="width: 100%;" name="manufacturer_api_country_id" id="manufacturer_api_country"  required>
                       <option value="0" disable="true" selected="true">=== Select Country ===</option>
                        @foreach ($countries as $key => $value)
                        <option value="{{$value->id}}">{{ $value->country_name }}</option>
                        @endforeach
...
<div class="col-12 col-sm-6">
  ...
  <!-- <span  id="product_manufacturer_api_save"  style="display:block">
    ...
    <tr>
        ...
        <tr>
        <td>{{$i++}}</td>
                <!-- <td>{{$api_manufacturers->application_id}}</td> -->
...
p.decleration 
{
    ...
    font-family: "Times New Roman", Times, serif;
      ...
      <div class="card" id="print_decleration">
        ...
        @foreach ($medicines as $key => $value_name) @endforeach
...
registration of ({{ $value_name->product_name }}, {{ $product_details->strength_amount_strength_unit }} and {{ $value_dosage->name }})
...
<!-- <label>I agree <input style="width:20px;position:float-center;" class="form-control" id="customCheckbox1" type="checkbox" name="customCheckbox1"   /></label>   -->
             ...
             <div class="col-12 col-sm-6">
        <input value="{{ $decleration_name }}" disabled class="form-control" id="decleration_name" type="text" name="decleration_name" placeholder="Name:"  />
        <input value="{{ $decleration_Qualification }}" disabled class="form-control" id="qualification" type="text" name="qualification"  placeholder="Qualification:" />
        <input value="{{$decleration_position}}"  disabled class="form-control" id="position_in_the_company" type="text" name="Position_in_the_company" Placeholder="Position in the company"  />
        <!-- <input class="form-control" id="Signature" type="text" name="Signature"  Placeholder="Signature" /> -->
        <input value="{{ $decleration_date }}"  disabledclass="form-control" id="Date_decleration" type="date" name="Date"  />
    ...
    @if( $decleration_present == 1)
    <input type="button" class="save action-buttonn" value="Save"    id="decleration_save"  style="display:block"     ></span>
