...
<section class="content">
   ...
   <div class="card card-primary">
    ...
    <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('application_in_processing') }}" aria-selected="true"> <span class="badge bg-primary"> New </span> </a>
        </li>
        <li class="nav-item">
            <a class="nav-link"  href="{{ route('in_process_on_going_renew_application') }}"  role="tab"  aria-selected="false">  <span class="badge bg-primary"> Re-register  </span> </a>
        </li> 
    </ul>
    <br>
 ...
 @endphp
                  ...
                  @php if($application->registration_type == 'New') {  $badge = 'badge bg-success'; } elseif($application->registration_type == 'Re-new')  { $badge = 'badge bg-success'; }  @endphp
                    ...
                    <a  title="Edit"  class='btn btn-sm btn-warning' 
                     href="{{ route('application.update',$application->application_id)  }}"> 
