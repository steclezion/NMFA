...
<label  style="display:block" id="new_application_mode_label" class="form control-label"  > Select Application Mode  </label>
...
<button   style="display:none; position: absolute;left: 45%; top: 85%;" type="button" class="btn btn-success" value="Update"    id="update_application_info"  >   Update </button> </span>
...
<label><i class="fas fa-phone fa-2xs" id="cont_response_tele"> {{ $country_contact_info->International_dialing }}</i> Phone Number</label> 
...
<button  style="display:none;position: absolute;left: 45%; top: 85%;"   type="button" class="btn btn-success _app" value="Save"    id="save_supplier_info"   >Save </button>
@else
...
<input value="{{ $agent_trade_name }}"  class="form-control" id="ag_trade_name" type="text" name="ag_trade_name" placeholder=""    required>
                        ...
                        <!-- <div class="input-group mb-3">
                        <select id="ag_trade_name"   style="display:block;width:350px;"   onchange="check_trade_agent_name(this.value)"  class="form-control select2bs4">
...
<i  style="color:blue;cursor:pointer;font-size:15px;" 
 title="Please ensure that the contact person you have listed is an active employee of the local agent company.
The contact person will be responsible for all the communications between the National Medicines and Food Administration (NMFA) and 
the local agent. "
 class="fas fa-info-circle fa-0">  
</i>
...
<button  style="display:none;position: absolute;left: 40%; top: 90%;"   type="button" class="btn btn-success" value="Save"    id="save_agent_info"   >Save </button>
...
<div class="form-card">
    ...
    <div class="col-12 col-sm-6">
    <label >Generic/Approved/International Non-proprietary Name(s)
   <i  style="color:blue;cursor:pointer;font-size:15px;" 
...
<br><br/>
            ...
            <label >Shelf life (In months only) <label>  
        ...
        <!--<input class="form-control" id="shelf_life_unit" type="number" name="shelf_life_unit"  required/>  -->
          ...
          <!--  <input class="form-control" id="proposed_shelf_life_unit" type="text" name="proposed_shelf_life_unit"  placeholder="in-months" required/>-->
            ...
            <input onkeyup="AllowonlyText_Tele(event,'proposed_shelf_life_after_reconstitution_amount')" min="1" value="{{$proposed_shelf_life_after_reconstitution_amount}}"   class="form-control" id="proposed_shelf_life_after_reconstitution_amount" type="number" name="proposed_shelf_life_after_reconstitution_amount"  required/>
...
<button  style="display:none;position: absolute;left: 40%; top: 90%;"   type="button" class="btn btn-success" value="Save"    id="save_product_detail_info"   >Save </button>
...
<span  id="createNewCompostion_save"  style="display:block"> 
    <span type="button"hidden class="btn btn-success btn-sm" title="Save entries for Product Compostion" title="Save composition"  id="createNewCompostion_save" ><i class="fas fa-save" > </i>   Save </span></span>
    ...
    <span type="button" hidden class="btn btn-success btn-sm" value="Update" title="Edit Composition" id="createNewCompostion_update" ><i class="fas fa-edit" > </i> Update </span></span>
    ...
    <button  hidden class="btn btn-warning btn-sm editcomposition"    value='{{ $product_composition->application_id }} '  id=''  data-di="{{ $product_composition->id }}"  ><i class='fas fa-pencil-alt'></i></button>
    <br/> <br/>
    <button  hidden class='btn btn-danger btn-sm'  onclick='Delete_composition({{ $product_composition->id }})' ><i class='fas fa-trash'></i></button> 
            </td>
               </tr>
            @endforeach
               </tbody>
...
<div class="container">
 ...
 <span class="badge"  id="id_for_update" style="display:none"></span> 
    ...
    <button  type="button" class="btn btn-success btn-sm" hidden   id="save_product_manufacturer_save"  ><i class="fas fa-save"> </i>   Save </button></span>
    ...
    <button type="button" class="btn btn-success btn-sm" hidden   id="updates_product_manufacturer_update"  ><i class="fas fa-edit"> </i>  Update </button></span>
...
<button hidden class='btn btn-warning btn-sm editmanufacturer' data-di='{{$products->mmid}}'  ><i class='fas fa-pencil-alt'></i></button>
           <br/> <br/>
<button hidden class='btn btn-danger btn-sm' onclick='Delete_Manufacturer({{ $products->manu_id }})' ><i class='fas fa-trash'></i></button>
...
@endphp
        ...
        <span class="badge"  id="id_for_update_api" style="display:none"></span>
        </h2>
...
<div class="col-12 col-sm-6">
    ...
    <button type="button" hidden class="btn btn-success btn-sm"    id="save_product_manufacturer_api_save" title="Save Button"> <i class="fas fa-save"> </i>    Save </button></span>
    ...
    <button type="button"  hidden class="btn btn-success btn-sm"    id="save_product_manufacturer_api_update" title="Edit Buttom"> <i class="fas fa-edit"> </i>    Update </button></span>
...
<span hidden class='btn btn-warning btn-sm editmanufacturer_api'   data-di='{{$api_manufacturers->api_id }}' ><i class='fas fa-pencil-alt'></i></span>
           <br/> <br/>
<span hidden class='btn btn-danger btn-sm' onclick='Delete_manufacture_api({{$api_manufacturers->api_id }})' ><i class='fas fa-trash'></i></span>
</td>
</tr>
@endforeach
</tbody>
...
<!-- <label>I agree <input style="width:20px;position:float-center;" class="form-control" id="customCheckbox1" type="checkbox" name="customCheckbox1"   /></label>   -->
   ...
   @endif
    ...
    <button type="button" class="btn btn-success"  hidden   id="decleration_save"   >  Update </button>
...
<button  hidden  style="position: absolute;left: 45%; top: 90%;" style="display:block;" type="button" name="next" class="btn btn-primary  app_recep_next" value="Next Step"  value="Confirm" id="confirm_finish" /> Confirm Finish </button>
<br><br>
