                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" class="form-control" data-inputmask-alias="text" placeholder="phone" data-mask>
                                </div>
                                <br>
                                <label>Fax:</label>
                                <div class="input-group">
                                    ...
                                    <input readonly type="text" class="form-control" data-inputmask-alias="text" placeholder="Fax" data-mask>
                                </div>
                            ...
                            <div class="input-group">
                                ...
                                <input readonly value="{{ $agent_contact_info_list->ag_email }}" type="text" class="form-control" data-inputmask-alias="text" placeholder="Institutional Email" data-mask>
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    ...
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input readonly value=" {{  $product_name->tname}}" type="text" class="form-control my-colorpicker1" placeholder="Proprietary/Trade name of the product:">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    @foreach ($dosage_forms as $dosage_formss)<br>@endforeach
...
<input readonly value="" type="text" class="form-control" placeholder="Route of administration:">
                      ...
                      <span class="input-group-text"><i class="fas fa-square"></i></span>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group my-colorpicker2">
                                    ...
                                    <input readonly value="{{  $dosage_formss->name   }}" type="text" class="form-control" placeholder="Pharmacotherapeutic Classification (Anatomic-Therapeutic Classification system)">
...
@endforeach
                            ...
                            <h5 style="font-size:25px">3.3.2 Name(s) and complete address(es) of the manufacturer(s) of the API(s) </h5>
                            ...
                            <table class="table table-bordered  table-condensed table-striped">
                                ...
                                <div class="card-body">
                                    <p class="decleration">
                                        ...
                                        <p class="decleration">
                                            I, the undersigned certify that all the information in this form and all accompanying documentation submitted to Eritrea for the registration of ({{ $value_name->product_name }}, {{ $value_name->strength_amount_strength_unit }} and {{ $value_dosage->name
                                            }}) manufactured at 
    ...
    <a href="{{ route('completeApplicationStatus',$app->application_id)}}" rel="noopener" target="_blank" class="btn btn-info"><i class="fas fa-print"></i> 
