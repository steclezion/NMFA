    ...
    <div class="tab-content" id="custom-content-below-tabContent">
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody {{ $i=1 }}>
                ...
                <tr>
                    <td>{{ $i++ }}</td>
                    <td>{{ $application->psur_refrence_number }}</td>
              ...
              elseif($application->application_status == 'Preliminary screening rejected') { $badge = 'badge bg-danger'; }
                    ...
                    <td>
                       ...
                       <!-- <a title="process registered applicant" class='btn btn-sm btn-warning' id="modal_upload_alert_notification"  >
        ...
        <table id="example3" class="table table-bordered table-striped">
            ...
            <tbody {{ $i=1 }}>
              ...
              elseif($application->application_status == 'Preliminary screening rejected') { $badge = 'badge bg-danger'; }
                    ...
                    <td>
                        @if(in_array('8',$explode))
                        <a style="color:white" class='btn btn-sm btn-info' title="Download application details" href="{{ route('view_completed_application',$application->application_id)  }}">
                            <i class='fas fa-eye'></i>
                        </a>
                        @else
                        <a title="Edit" class='btn btn-sm btn-warning' href="{{ route('application.update',$application->application_id)  }}">
