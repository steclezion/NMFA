...
@foreach($application_details as $app_details) @endforeach
    ...
    <div class="row justify-content-center mt-0">
        ...
        <div  class="alert alert-success align-content-sm-center" id="app_id" ></div>
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3" id="Application_submission">
             <input type="hidden" name="stegnant_application_number"  value="{{ $app_details->application_number }}" id="stegnant_application_number"/>
             <input type="hidden" name="old_app_id"  value="{{ $app_old_id }}" id="old_app_id"/>

               
                <h2>Application Submission Re-registration Process</h2>
                
                <p>Fill all form fields to go to the next step <i   style="color:blue;cursor:pointer" id="modal_show_detail_information" title="Guidelines on Application Submission process"  class="fas fa-info-circle">  </i></p>
...
<!---------------------------------------------------------------------------------------------------------   -->
    ...
    <div class="row">   
    <div class="col-sm-3">
    <!-- <label  >Re-New Application </label>   -->
...
<label> Specify Applicant Name (If other) </label> 
 <input placeholder="other" class="form-control"   value="0" id="trade_names_other" type="text" name="trade_names"    required>
...
<label>Phone Number<i style="color:red;cursor:pointer;font-size:20px;">*</i></label>
<input  class="form-control" id="cont_tele" onkeyup="AllowonlyTex_Telet(event,'cont_tele')" min="0" type="number" name="telephone"  />
 ...
 <!-- <option value="0" disable="true" selected="true">Select Country</option>-->
  ...
  <label> city<i style="color:red;cursor:pointer;font-size:20px;">*</i> </label> 
   ...
   <label> Email<i style="color:red;cursor:pointer;font-size:20px;">*</i> </label>      
    ...
    <input min="0" onkeyup="AllowonlyText_Tele(event,'cs_tele')"  class="form-control" id="ag_tele" type="text" min="0" name="telephone"  />
...
<label>Fax<i style="color:red;cursor:pointer;font-size:20px;">*</i></label>
    ...
    <input class="form-control" id="product_trade_name"  type="text" name="product_trade_name"   />
        <label>Dosage Forms<i style="color:red;cursor:pointer;font-size:20px;">*</i> </label>  
            ...
            <select style="display:block;width:300px;" class="form-control select2bs4" id="dosage_form_id"  name="dosage_form_id"  required>
                                    <option value="" disable="true" selected="true">=== Select Dosage Forms  ===</option>
...
<br><br/>
            ...
            <input onkeyup="AllowonlyText_Tele(event,'proposed_shelf_life_amount')"  class="form-control" id="proposed_shelf_life_amount" 
            type="number" name="proposed_shelf_life_amount"  required/>
            ...
            <select hiiden style="display:none" class="form-control" id="proposed_shelf_life_unit"  name="proposed_shelf_life_unit"  required  onchange="proposed_shelf(this.value,)">
...
<div class="card-body">
<p class="decleration"> 
I, the undersigned certify that all the information in this form and all accompanying documentation 
submitted to Eritrea for the registration of
 (<span id="d_p_name"> name </span> , <span id="d_stregth"> strength </span> ,

<span id="d_dname">dosage form of the product </span>) 
manufactured at (
    
    <span id="d_manu_state"> name </span> and 
    <span id="address_manufacture"> address of manufacturer</span> ) is true and correct. 
I further certify that I have examined the following statements and I attest to their correctness:- 
</P>
