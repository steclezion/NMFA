...
<input class="form-control" id="generated_application_id" type="hidden" name="Application_ID"  value="{{ $app->application_id }}" />
...
<option value="1" selected='true'> Standard Mode </option>
@elseif($app->application_type == 2 && $app->fast_track_details == 'MoH Tender' )
<option value="2_MoH Tender"  selected='true' >Fast Track Mode MoH Tender</option>
@elseif($app->application_type == 2 && $app->fast_track_details == 'SRA product' )
<option value="2_SRA product"  selected='true' >Fast Track Mode SRA product</option>
@elseif($app->application_type == 2 && $app->fast_track_details == 'WHO PQP' )
<option value="2_WHO PQP"  selected='true' >Fast Track Mode WHO PQP</option>
@endif
@endforeach
@if($app->application_type != 1) 
...
<input value="{{ $applications->email_supplier }}" class="form-control"  onkeyup="Email_Validate(this.value,'{{url('/Validate/email/customer_supply')}}','cs_response_email','save_supplier_infoo','cs_email')" id="cs_email" type="email" name="email" placeholder="Email" />
...
<input  onkeyup="AllowonlyText_Tele(event,'manufacturer_tele')" min="0" value="{{ $applications->telephone_supplier }}" class="form-control" id="cs_tele" type="number" name="telephone"  />
...
<i class="fas fa-phone fa-2xs" id="cont_response_tele"> {{ $country_contact_info->International_dialing }}</i> 
<label>Phone Number<i style="color:red;cursor:pointer;font-size:20px;">*</i></label> 
<input  class="form-control" id="cont_tele" min="0" type="number" name="telephone"   onkeyup="AllowonlyTex_Telet(event,'cont_tele')" value="{{ $applications->cont_telephone}}" />
...
foreach($agent_contact_info as $agent_contact_info) {} foreach($agent_contact_County_info as $agent_contact_County_info)  {}
 ...
 @endphp
   ...
   title="Please visit Guidance for the Authorization of Local Agents for further guidance."
    ...
    <label> Agent Business Name<i style="color:red;cursor:pointer;font-size:20px;">*</i>  </label>
    ...
    <!-- <div class="input-group mb-3">
             ...
             <label> Phone Number<i style="color:red;cursor:pointer;font-size:20px;">*</i> </label>
             <input   min="0" onkeyup="AllowonlyText_Tele(event,'ag_tele')" class="form-control"   value="{{ $agent_telephone   }}" id="ag_tele" type="number" min="0" value="" name="telephone"  />
                ...
                <label> Web site Url<i style="color:red;cursor:pointer;font-size:20px;">*</i> </label>
...
<input  min="0" onkeyup="AllowonlyText_Tele(event,'cont_ag_tele')"  value="{{ $agent_contact_person_telephone }}" class="form-control" id="cont_ag_tele"  name="telephone"    type="number" min="0"/>
...
<div class="container">
 ...
 <span class="badge"  id="id_for_update" style="display:none"></span> 
    ...
    <label>Manufacturer Name<i style="color:red;cursor:pointer;font-size:20px;">*</i></label>  
        ...
        <label>Country<i style="color:red;cursor:pointer;font-size:20px;">*</i></label>  
        <select onchange="fetch_tele(this.value,'manu_response_tele','{{url('/get_tele_code/tele_code')}}')" class="form-control select2bs3" style="width: 100%;" name="manufacturer_country_id" id="manufacturer_country"  required>
...
@include('layouts.custom_re_register')
