                    ...
                    <div class="timeline">
                        ...
                        @foreach($tasks as $task)
                            <div>
                                ...
                                @elseif($task->task_category=='Dossier Evaluation')
                                                        ...
                                                        <table class="table table-borderless table-sm">
                                                            ...
                                                            @if( $task->updated_at !=null)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-left text-bold">{{$task->updated_at}}</td>
                                                                </tr>
                                                            @endif
                                                            ...
                                                            @if($task->uploaded_document_id!=null)
                                                                    ...
                                                                    @if($task->task_category!= 'Assessment Report' and $task->task_category!= 'Document Submission Response')

                                                                        @foreach($uploaded_documents as $uploaded_document)
                                                                        {{--get the documents of this task only, match document_id with task_trackers document id--}}
                                                                        @if($uploaded_document->uploaded_document_id == $task->uploaded_document_id)

                                                                   <tr>
                                                                       <td class="text-muted">Document</td>
                                                                                <td class="text-left">
                                                                                    <a href="{{asset($uploaded_document->path)}}"
                                                                                       target="_blank"
                                                                    ...
                                                                    @elseif($task->task_category == 'Assessment Report')
                                                                        <tr>
                                                                            <td class="text-muted">Documents
                                                                            </td>
                                                                            <td class="text-left">
                                                                                {{--get the documents of this task only, match document_id with assessment report id--}}
                                                                        @foreach($assessment_reports_for_this_dossier as $report)
                                                                            @foreach($uploaded_documents_assessment_reports_sent as $document)
                                                                                @if($task->uploaded_document_id == $report->id)
                                                                    ...
                                                                    @elseif($task->task_category == 'Document Submission Response')
                                                                        <tr>
                                                                            <td class="text-muted">Documents
                                                                            </td>
                                                                            <td class="text-left">
                                                                                {{--get the documents of this task only, match document_id with assessment report id--}}
                                                                                @foreach($assessment_reports_for_this_dossier as $report)
                                                                                    @foreach($uploaded_documents_assessment_reports_received as $document)
                                                                                        @if($task->uploaded_document_id == $report->id)
                                                                           <a href="{{asset($document->path)}}"
                                                                                               target="_blank"
                                                                                               class="btn btn-success btn-sm"><i
