...
<div class="modal fade" id="ajaxModel_receipt_receive" aria-hidden="true" data-backdrop="static" tabindex="-1">
    <div class="modal-dialog modal-lg">
    <input type="hidden" value="{{ Auth::user()->id }}" id="user_id" />
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modelHeading_re"></h4>
...
<input hidden id="application_id" value="" />
<div class="container"> 
  ...
  <br/>
  <div class="panel-body"  >Ref: <span id="RL_squential_number">  </span>  </div>
  <br/>
  <div class="panel-body">
 To: <span id="applicant_name">  </span>  <br/>
 <ul>
    <li> <span id="state_plot_number">  </span> </li> <br/>
    <!-- <li> <span id="country">  </span> </li>  </br> -->
    <li> <span id="region_state"> </span>  </li>    </br> 
  </ul>
</div>
</div>
  </p>
...
<p>Dear Sir/Madam or  <span id="contact_person_name">  </span> ,</p>
<br/>
This is to acknowledge receipt of your application for registration of a medicine in reference to your 
letter dated <input type="date" min="0" width="10" hieght="10"   id="date_of_letter" /> . 
The application number for the below product is  <b> <span id="application_number">  </span> </b>.
<br><br>
<p>
Product Name: <span id='p_n'> [Name of the product, dosage form, strength], [Brand name]  </span>
<br><br>
Documents received:
</p>

<ul>
<textarea   id="document_received_types"   style="position:relative;left:0px"  placeholder="[list out the received document types in bullets]"  name="remark" class="form-control"  auto/>
</textarea>
</ul>
<br>
<p>   No. of DVDs received: <input type="number" min="0" width="10" height="10"   id="dvd_received" /> .    </p>
...
<img src="../../../images/nmfa_footer.png"  class="img-responsive" alt="image" style="width: 100%;height: auto;"/>     
              ...
              <div class="col-md-offset-2 col-sm-10">
      <button style="display:block"  type="submit" class="btn btn-primary" id="saveBtnn" >Save</button>
