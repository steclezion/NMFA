...
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
 ...
 <div class="form-group">
                        ...
                        <div class="col-sm-12">
                       <input readonly  id="deadline" name="deadlineDate" required=""  type="date" value="@php $t=time(); echo date("Y-m-d",$t); @endphp"  class="form-control">
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ route('assigned_psur.index') }}",
        columns: [
    ...
    $('body').on('click', '.editAssign', function () {
      ...
      var psur_refrence_number = $(this).data('psur_refrence_number');
          ...
          $('#modelHeading').html("Re-assign PSUR");
