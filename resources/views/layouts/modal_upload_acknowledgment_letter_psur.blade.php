...
<!-- <form id="ACKForm"    enctype="multipart/form-data"  action="{{ route('upload_file_acknowledgement') }}"  method="POST" name="ACKForm" class="form-horizontal"  > -->
              ...
              <input hidden id="psur_reference_number_hidden"  name="psur_reference_number_hidden" value="{{$psur_reference_number->psur_refrence_number}} " />
...
$('#upload_acknowledgment_letter_psur').click(function () {
        //alert("hellow Eyoba");
      ...
      var psur_refrence_number  = $('#psur_reference_number_hidden').val();
