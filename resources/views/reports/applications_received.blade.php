    ...
    <section class="content">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <h4 class="text-center display-5">Application Received</h4>
            </div>
            <!-- /.container-fluid -->
        </section>

        <!-- Main content -->
        <form action="{{route('get_application_received')}}" method="post">
            @csrf
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2 select2-hidden-accessible" multiple=""
                                                style="width: 100%;" name="status_type[]" tabindex="-1"
                                                aria-hidden="true">
                                                
                                            <option value="All"
                                                    @if(isset($search_history)) @if(  in_array("All", $search_history['status_type'])) selected @endif @endif >
                                                All
                                            </option>
                                            <option value="Preliminary screening completed"
                                                    @if(isset($search_history)) @if(  in_array("Preliminary screening completed", $search_history['status_type'])) selected @endif @endif >
                                            
                                             Preliminary screening completed
                                            </option>
                                            <option value='Preliminary screening rejected'
                                                    @if(isset($search_history)) @if(  in_array("Preliminary screening rejected", $search_history['status_type'])) selected @endif @endif >
                                            Preliminary screening rejected
                                            </option>
                                            <option value='processing'
                                                    @if(isset($search_history)) @if(  in_array("processing", $search_history['status_type'])) selected @endif @endif >
                                               processing
                                            </option>
                                            </select>
                                    </div>
                            ...
                            @if(isset($application_count_by_year))
                                <hr/>
                                <br/>
                                <h4 class="text-primary">Applications Received from
                                ...
                                <table class="table table-bordered  dataTable no-footer dtr-inline "
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example1"
                                            ...
                                            aria-sort="ascending" width="10%">Applications Received
                                        </th>
                                    </thead>
                                    <tbody>
                            ...
                            @if(isset($data))
                                ...
                                <br/>
                                <h4 class="text-primary">List of Applications Received</h4>
                                ...
                                <div id="example_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer ">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Serial Number: activate to sort column descending" aria-sort="ascending" width="5%">Reference Num.</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Title: activate to sort column ascending" width="10%">Country</th>
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Title: activate to sort column ascending" width="15%">Local Agent</th>
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Type: activate to sort column ascending" width="15%">Received On</th>
                                        ...
                                        <th rowspan="1" colspan="1" width="5%">Application status</th>
                                    ...
                                    @foreach($data as $report)
                                        <tr role="row" class="odd">
                                            ...
                                            <td>{{$report['trade_name']}}</td>   {{--company name--}}
                                            <td>{{$report['country_name']}}</td>
                                            <td>{{$report['local_agent_company_name']}}</td>
                                            <td>{{$report['generic_name']}}</td>
                                            <td>{{$report['product_name']}}</td>
                                            <td>{{$report['application_created_date']}}</td>
                                            <td>{{$report['application_type']}}</td>
                                            @if( "Preliminary screening completed" == $report['application_status'])
                                                <td><span class="badge badge-success">Preliminary screening completed</span></td>

                                            @elseif( "Preliminary screening rejected" == $report['application_status'])
                                                <td><span class="badge badge-danger">Preliminary screening rejected</span></td>
                                            @elseif( "processing" == $report['application_status'])
                                                <td><span class="badge badge-primary">Processing</span></td>
                                                @else
                                                <td><span class="badge badge-secondary">{{$report['application_status']}}</span></td>
                                            @endif
                                            <td>
                                                {{$report['process_type']}}
