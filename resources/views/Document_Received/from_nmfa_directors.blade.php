...
<div class="container">
    ...
    <li class="nav-item">
                <a class="nav-link active" href="{{route('documents_nmfa_alerts') }}" role="tab" aria-controls="custom-content-below-profile" aria-selected="false">Directors Alert Notification</a>
              </li>
    ...
    <table class="table table-bordered data-table" style="background-color:skybluee">
        <thead>
                    <tr>
                    <th>ID</th>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
         ajax: "{{ route('documents_nmfa_alerts') }}",
