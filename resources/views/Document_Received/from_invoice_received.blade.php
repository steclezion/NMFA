          ...
          <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              <li class="nav-item">
                <a href="{{route('doc.index') }}" class="nav-link" id="custom-content-below-home-tab"  role="tab" aria-controls="custom-content-below-home" aria-selected="true">Acknowledgment letters </a>
                 ...
                 <li class="nav-item">
                <a class="nav-link active" href="{{route('documents_invoice.invoice_received') }}" role="tab" aria-controls="custom-content-below-profile" aria-selected="false"> Invoices  </a>
              </li>
...
<script type="text/javascript">
  $(function () {
    ...
    var table = $('.data-table').DataTable({
        processing: true,
        serverSide: true,
         ajax: "{{ route('documents_invoice.invoice_received') }}",
