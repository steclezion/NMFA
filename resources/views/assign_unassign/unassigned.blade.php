...
<div class="container">
       ...
       <div class="card card-primary card-outline">
          ...
          <div class="card-body">
            ...
            <li class="nav-item"> 
                <a class="nav-link active" href="{{route('un-assignment.index') }}" role="tab" aria-controls="custom-content-below-profile" 
...
@include('layouts.modal_assign_unassign_unassigned')
@endsection